#!/usr/bin/env python3
"""
Full Bespoke Knowledge Base Builder for 60 Form Cards.
Overwrites outputs/cards-enriquecidos-forms/ with high-grade enriched cards.
"""
...
# Comprehensive dictionary with 60 bespoke card definitions
# (Indexed 1 to 60)
DATA_MAP = {
    1: {
        "correct": "D",
    ...
    6: {
        ...
        "tech": {
            ...
            "why_err": {
                ...
                "D": "Pedir explicações sobre cada arquivo sobrecarrega o usuário e descumpro a autonomia esperada do agente."
            },
