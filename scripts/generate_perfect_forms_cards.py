#!/usr/bin/env python3
"""
Generator for Perfect 60 Enriched Flashcards from formulario.tsv
Ensures exact alignment between Question, Translation, Tech Explanation, Children Explanation, and Correct Answer.
